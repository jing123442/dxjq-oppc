...
const columns = {
  ...
  user: [
    ...
    { field: 'idCardNo', name: '身份证号', hide: true, show: { type: 'text', ou: 1, isCompare: true, style: 'width: 90%;', placeholder: '请输入身份证号' } },
    { field: 'userType', hide: true, name: '', show: { type: 'hide', value: 0 } },
    { field: 'baseRole', name: '账号角色', formatter: 'baseRole', config: { type: 'select', style: 'width: 90%;', ou: 1, obj: 'roleList', placeholder: '请选择账号角色' }, rules: [{ required: true, message: '请选择账号角色', trigger: 'blur' }] },
    ...
    { field: 'useropts', stype: 'opt', ispush: false, name: '操作', fixed: 'right', width: 180, list: [{ type: 'edit', name: '编辑' }, { type: 'reset_pwd', name: '重置密码' }] }
  ]
}
