...
const columns = {
  ...
  directOrder: [
    ...
    { field: 'tradeType', name: '交易模式', formatter: 'tradeType', search: { type: 'select', obj: 'tradeType', placeholder: '交易模式' }, detail: { type: 'span', model: 'select', style: 'width: 85%', obj: 'tradeType', serial: 3 } },
