...
const columns = {
  message: [
    ...
    { field: 'clientRoleTableList', stype: 'list-tag', ispush: false, porps: { name: 'title' }, name: '接收角色', detail: { type: 'span', stype: 'format', formatFun: 'roleList', isDisabled: true, serail: 5, obj: 'roleList' } },
