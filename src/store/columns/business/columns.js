const columns = {
  state: {
    org: [
      ...
      { field: 'idNum', nameSpan: 10, name: '身份证号码', hide: true, show: { type: 'text', ou: 2, placeholder: '请输入身份证号码' }, rules: [{ required: true, message: '请输入身份证号码！', trigger: 'blur' }] },
      ...
      { field: 'updateDate', nameSpan: 10, name: '更新时间', hide: true },
      { field: 'updater', nameSpan: 10, name: '', hide: true },
      { field: 'updaterName', nameSpan: 10, name: '', hide: true },
      { field: 'orgType', nameSpan: 10, name: '', hide: true },
      { field: 'creater', nameSpan: 10, name: '', hide: true },
