...
const columns = {
  ...
  dyncDayInfo1: [
    { field: 'nickName', name: '装车时间', fixed: 'left' },
    { field: 'outTime', name: '槽车车牌号' },
    { field: 'outPrice', name: '装车量(公斤)' },
    { field: 'outPrice', name: '采购价(元/公斤)' },
    { field: 'outPrice', name: '入库统计类型' },
    { field: 'outPrice', name: '入库时间' },
    { field: 'outPrice', name: '入库量(公斤)' },
    { field: 'outPrice', name: '到站价(元/公斤)' },
    { field: 'outPrice', name: '前 1 交班日 未出库量(公斤)' },
    { field: 'outPrice', name: '出库统计时间' },
    { field: 'outPrice', name: '出库统计类型' },
    { field: 'outPrice', name: '出库统计量(公斤)' },
    { field: 'outPrice', name: '出库统计价(元/公斤)' },
    { field: 'outPrice', name: '销售方式' },
    { field: 'outPrice', name: '销售量(公斤)' },
    { field: 'outPrice', name: '销售价(元/公斤)' },
  ],
  dyncDayInfo2: [
