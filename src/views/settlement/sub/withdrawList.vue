...
export default {
  ...
  methods: {
    ...
    onReqParams(type, _this, callback) {
      const querys = { param: { withdrawOrder: { orgId: this.$route.query.orgId, tradeType: this.$route.query.tradeType }, dateParam: { periodYear: this.$route.query.periodYear, periodMonth: this.$route.query.periodMonth } } }
