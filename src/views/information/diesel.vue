<template>
  <div class="template-main">
    <em-table-list ref="tables" :tableListName="'infordiesel'" style="flex: 1;" :authButtonList="authButtonList" :buttonsList="buttonsList" :axios="axios" :queryCustURL="queryCustURL" :responseSuccess="response_success" :queryParam="queryParams" :mode_list="mode_list" :page_status="page_status" :page_column="page_column" :select_list="select_list" @onListEvent="onListEvent" @onReqParams="onReqParams"></em-table-list>
        ...
        <el-form-item>
          ...
          <div style="padding-left: 20px;">
            <el-upload
              ...
              :headers="headers"
              accept=".xls,.xlsx"
              action="information/lng_pick_up_price/imports"
              :auto-upload="false">
...
import { $importDieselFile } from '@/service/information'
...
export default {
  ...
  data() {
    return initVueDataOptions(this, {
      ...
      queryCustURL: {
        list: {
          url: 'information/diesel_oil/list',
          method: 'post',
          parse: {
  ...
  computed: {
    ...mapGetters({
      page_column: 'information_diesel_column',
      mode_list: 'information_diesel_mode_list',
      page_status: 'information_diesel_page_status',
      select_list: 'information_diesel_select_list',
