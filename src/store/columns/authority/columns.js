...
const columns = {
  ...
  user: [
    ...
    { field: 'orgId', stype: 'mapping', name: '企业名称', mapping: 'orgName', fixed: 'left', show: { type: 'select', remote: true, subField: 'orgName', findKey: 'orgName', paramKey: ['param', 'org'], ou: 1, obj: 'orgId', isDisabled: true, style: 'width: 90%;', placeholder: '请选择企业名称' }, search: { type: 'text', field: 'orgName', placeholder: '请输入企业名称' }, config: { type: 'span', model: 'select', obj: 'orgId', style: 'width: 90%;' }, rules: [{ required: true, message: '请选择企业名称！', trigger: 'blur' }] },
    { field: 'userName', name: '姓名', show: { type: 'text', ou: 1, style: 'width: 90%;', placeholder: '请输入姓名' }, search: { type: 'text', placeholder: '请输入姓名' }, config: { type: 'span', style: 'width: 90%;' }, rules: [{ required: true, message: '请输入姓名！', trigger: 'blur' }] },
    ...
    { field: 'baseRole', name: '账号角色', formatter: 'baseRole', show: { type: 'select', style: 'width: 90%;', ou: 1, obj: 'roleList', isDisabled: true, placeholder: '请选择账号角色' }, config: { type: 'select', style: 'width: 90%;', ou: 1, obj: 'roleList', placeholder: '请选择账号角色' }, rules: [{ required: true, message: '请选择账号角色', trigger: 'blur' }] },
    { field: 'status', name: '账号状态', formatter: 'status', width: 120, filters: [{ value: 0, text: '启用' }, { value: 1, text: '停用' }], show: { type: 'radio', value: 0, ou: 1, obj: 'status', placeholder: '请选择账号状态' }, config: { type: 'radio', obj: 'status' }, rules: [{ required: true, message: '请选择账号状态！', trigger: 'blur' }] },
    { field: 'useropts', stype: 'opt', ispush: false, name: '操作', fixed: 'right', width: 180, list: [{ type: 'config_role', name: '配置角色' }, { type: 'edit', name: '编辑' }, { type: 'reset_pwd', name: '重置密码' }] }
  ]
}
