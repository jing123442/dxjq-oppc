const columns = {
  op: [
    ...
    { field: 'orgId', stype: 'mapping', name: '企业名称', mapping: 'orgName', show: { type: 'select', subField: 'orgName', ou: 1, obj: 'orgId', isDisabled: true, style: 'width: 90%;', placeholder: '请选择企业名称' }, search: { type: 'text', field: 'orgName', placeholder: '请选择企业名称' }, rules: [{ required: true, message: '请选择企业名称！', trigger: 'blur' }] },
    ...
    { field: 'mobile', name: '电话', show: { type: 'text', ou: 1, isCompare: true, style: 'width: 90%;', placeholder: '请输入电话' }, search: { type: 'text', placeholder: '请输入电话' }, rules: [{ required: true, message: '请输入电话！', trigger: 'blur' }] },
  ...
  cashier: [
    { field: 'userId', name: '', stype: 'checkbox', align: 'center', fixed: 'left', width: 50 },
    { field: 'orgId', stype: 'mapping', name: '企业名称', mapping: 'orgName', show: { type: 'select', remote: true, subField: 'orgName', ou: 1, obj: 'orgId', isDisabled: true, style: 'width: 90%;', placeholder: '请选择企业名称' }, search: { type: 'text', field: 'orgName', placeholder: '请选择企业名称' }, rules: [{ required: true, message: '请选择企业名称！', trigger: 'blur' }] },
    { field: 'userName', name: '姓名', show: { type: 'text', ou: 1, style: 'width: 90%;', placeholder: '请输入姓名' }, search: { type: 'text', placeholder: '请输入姓名' }, rules: [{ required: true, message: '请输入姓名！', trigger: 'blur' }] },
    { field: 'userCode', name: '登录账户', show: { type: 'text', ou: 1, isCompare: true, style: 'width: 90%;', placeholder: '请输入登录账户' } },
    { field: 'mobile', name: '电话', show: { type: 'text', ou: 1, isCompare: true, style: 'width: 90%;', placeholder: '请输入电话' }, search: { type: 'text', placeholder: '请输入电话' }, rules: [{ required: true, message: '请输入电话！', trigger: 'blur' }] },
    { field: 'lastLoginDate', name: '最后登录时间', ispush: false },
