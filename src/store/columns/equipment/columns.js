...
const columns = {
  ...
  gasLevelEquipment: [
    ...
    { field: 'gaugeNorm', name: '液位计规格编号', nameSpan: 6,  show: { type: 'text', serial: 2, placeholder: '请输入液位计规格编号' }, rules: [{ validator: 'validateMoneyNumber', message: '只能输入正数且保留两位小数', trigger: 'blur' }]},
