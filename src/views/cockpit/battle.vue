          ...
          <div class="bm-content">
            <div class="bm-content__price">
              <div class="bm-content__price-item">
                <div class="name">平台结算价<span class="timer">(11:29:53)</span></div>
                <div class="price">￥3.67/公斤</div>
              </div>
              <div class="bm-content__price-item">
                <div class="name">线下结算价<span class="timer">(11:29:53)</span></div>
                <div class="price">￥3.67/公斤</div>
              </div>
              <div></div>
            </div>
      ...
      <div class="map-card">
        ...
        <div class="card-control">
          ...
          <ul class="card-list" :style="{ height: (mapHeight - 345) + 'px'}">
            <li v-for="(item, index) of gasstationList" :key="index" :class="'icon-' + (item.gasType || 2004)" @click="markerClickEvent(item)">
              <div class="title">
                <div>
                  <span class="item-name text-overflow-ellipsis">{{item.gasstationName}}</span>
                  <span class="item-tag">[{{getGasstationTypeName(item.gasType)}}]</span>
