<template>
  <div class="template-main">
    <em-table-list ref="tables" :tableListName="'inforhaiqi'" style="flex: 1;" :authButtonList="authButtonList" :buttonsList="buttonsList" :axios="axios" :queryCustURL="queryCustURL" :responseSuccess="response_success" :queryParam="queryParams" :mode_list="mode_list" :page_status="page_status" :page_column="page_column" :select_list="select_list" @onListEvent="onListEvent" @onReqParams="onReqParams"></em-table-list>
        ...
        <el-form-item>
          ...
          <div style="padding-left: 20px;">
            <el-upload
              ...
              :headers="headers"
              accept=".xls,.xlsx"
              action="information/lng_sea_air_price/imports"
              :auto-upload="false">
...
import { $importHaiqiFile } from '@/service/information'
...
export default {
  ...
  data() {
    return initVueDataOptions(this, {
      ...
      queryCustURL: {
        list: {
          url: 'information/lng_sea_air_price/list',
          method: 'post',
          parse: {
  ...
  computed: {
    ...mapGetters({
      page_column: 'information_haiqi_column',
      mode_list: 'information_haiqi_mode_list',
      page_status: 'information_haiqi_page_status',
      select_list: 'information_haiqi_select_list',
  ...
  methods: {
    ...
    btnClickEvent(btnObj, row) {
      if (btnObj.type === 'ok') {
        ...
        $importHaiqiFile({ file: _fromData, headers: this.headers }).then(response => {
