<template>
  <div class="template-main">
    ...
    <el-dialog title="物流公司" :visible.sync="dialogAddGasStationVisible" :width="add_edit_dialog" :append-to-body="true">
      <nt-form ref="addGap" v-if="dialogAddGasStationVisible" :rowData="authRow" :inputType="inputType" :modeList="auth_page_mode" :pageColumn="auth_page_column" :selectList="select_list" :axios="axios" :queryURL="queryCustURL" :responseSuccess="response_success" @onListEvent="onFormEvent"></nt-form>
    </el-dialog>
...
export default {
  ...
  computed: {
    ...mapGetters({
      ...
      mode_detail_self_manage: 'common_unauth_self_mode_list',
