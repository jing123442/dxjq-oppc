...
const columns = {
  ...
  vehicle: [
    ...
    { field: 'carNumber', name: '车牌号', show: { type: 'text', style: 'width: 90%;', placeholder: '请输入车牌号' }, search: { type: 'text', placeholder: '请输入车牌号' }, detail: { type: 'span', serial: 2, ou: 0, isDisabled: true }, rules: [{ required: true, message: '请输入车牌号', trigger: 'blur' }] },
