...
export default {
  ...
  methods: {
    ...
    onReqParams(type, _this, callback) {
      const querys = { param: { carrierGasstation: { carrierOrgId: this.$route.query.orgId, tradeType: this.$route.query.tradeType }, dataParam: { periodYear: this.$route.query.periodYear, periodMonth: this.$route.query.periodMonth } } }
