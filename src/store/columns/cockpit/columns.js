...
const columns = {
  ...
  battle: [
    ...
    { field: 'offlineGasQty', name: '日加气量',
      show: { type: 'text', ou: 1, style: 'width: 85%', rule: false, placeholder: '请输入日加气量', util: '吨' },
      ...
      rules: [{ required: true, message: '请输入日加气量', trigger: 'change' }, { validator: 'validateInputValueNumber', message: '日加气量[0, 1000000]', option: { min: 0, max: 1000000 }, trigger: 'blur' }] },
    ...
    { field: 'offlinePrice', name: '结算价',
      show: { type: 'text', ou: 1, style: 'width: 85%', rule: false, placeholder: '请输入结算价', util: '元/公斤' },
      ...
      rules: [{ required: true, message: '请选择站点类型', trigger: 'change' }, { validator: 'validateInputValueNumber', message: '结算价[0, 1000000]', option: { min: 0, max: 1000000 }, trigger: 'blur' }] },
