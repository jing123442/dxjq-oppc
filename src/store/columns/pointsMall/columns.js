...
const columns = {
  ...
  goods: [
    ...
    { field: 'goodsStatus', name: '商品状态', formatter: 'goodsStatus', show: { type: 'radio', ou: 0, obj: 'goodsStatus', placeholder: '商品状态', value: '0' }, search: { type: 'select', obj: 'goodsStatus', placeholder: '商品状态' }, rules: [{ required: true, message: '请选择商品状态', trigger: 'blur' }], detail: { type: 'radio', isDisabled: true, obj: 'goodsStatus', serial: 0, ou: 0 } },
