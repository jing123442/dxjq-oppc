...
import { utilsTableOptionsToFilters, utilsContractStatus } from '@/utils/select'
...
const columns = {
  ...
  carrierUnAuthInfo: [
    ...
    { field: 'authDate', name: '认证时间', stype: 'format', formatFun: 'formateTData all', width: 140,
      search: { type: 'date-picker', placeholder: '' } },
    { field: 'roadTransportStatus', name: '道路运输许可证' },
  ...
  vehicle: [
    { field: 'orgId', name: '公司名称', stype: 'mapping', mapping: 'orgName', fixed: 'left',
      show: { type: 'hide', subField: 'orgName' },
      search: { type: 'text', field: 'orgName', placeholder: '请输入公司名称' },
      rules: [{ required: true, message: '请输入公司名称', trigger: 'blur' }] },
    { field: 'truckId', name: '', hide: true },
    { field: 'truckName', name: '卡车品牌', hide: true,
    ...
    { field: 'linked', name: '车辆类型', formatter: 'truckType',
    ...
    { field: 'frameNumber', name: '车架号', hide: true,
      show: { type: 'text', style: 'width: 90%;', placeholder: '请输入车架号' },
      detail: { type: 'span', serial: 3, ou: 0 },
      rules: [{ required: true, message: '请输入车架号', trigger: 'blur' }] },
    { field: 'trailerNumber', name: '挂车牌号', hide: true,
      show: { type: 'text', style: 'width: 90%;', placeholder: '请输入挂车牌号' },
      detail: { type: 'span', serial: 4, ou: 0, isDisabled: true } },
    { field: 'purchaseDate', name: '购车日期', hide: true,
      show: { type: 'date-picker', model: 'date', format: 'yyyy-MM-dd', style: 'width: 90%;', placeholder: '请输入购车日期' },
      detail: { type: 'span', serial: 5, ou: 0, isDisabled: true } },
    { field: 'color', name: '颜色', hide: true,
      show: { type: 'text', style: 'width: 90%;', placeholder: '请输入颜色' },
      detail: { type: 'span', serial: 6, ou: 0, isDisabled: true } },
    { field: 'deadWeight', name: '载重量', hide: true,
      show: { type: 'text', style: 'width: 90%;', placeholder: '请输入载重量' },
      detail: { type: 'span', serial: 7, ou: 0, isDisabled: true, util: '吨' } },
    { field: 'capacity', name: '储气罐容量', hide: true,
      show: { type: 'text', style: 'width: 90%;', placeholder: '请输入储气罐容量' },
      detail: { type: 'span', serial: 8, ou: 0, isDisabled: true, util: '升' } },
    { field: 'manufacturer', name: '生产厂家', hide: true,
      show: { type: 'text', style: 'width: 90%;', placeholder: '请输入生产厂家' },
      detail: { type: 'span', serial: 9, ou: 0, isDisabled: true } },
    { field: 'status', name: '车辆状态', formatter: 'status',
      show: { type: 'radio', value: 0, obj: 'status', placeholder: '请选择车辆状态' },
      search: { type: 'select', obj: 'status', placeholder: '请选择车辆状态' },
      detail: { type: 'span', model: 'select', obj: 'status', serial: 12, ou: 2, isDisabled: true },
      rules: [{ required: true, message: '请选择车辆状态！', trigger: 'blur' }] },
    { field: 'autoAccount', name: '圈存方式', hide: true,
      show: { type: 'radio', obj: 'autoAccount', value: 0, placeholder: '请选择圈存方式' },
      rules: [{ required: true, message: '请选择圈存方式', trigger: 'blur' }] },
    { field: 'truckDriverList', name: '当前绑定司机', ispush: false, formatter: '', stype: 'list-tag', action: { name: 'driverName' },
      detail: { type: 'span', name: '绑定司机', formatFun: 'truckToDriverList', stype: 'format', serial: 10, ou: 1, isDisabled: true } },
    { field: 'balance', name: '账户余额', ispush: false, hide: true,
      detail: { type: 'span', serial: 11, ou: 2, isDisabled: true, defaultValue: 0 } },
