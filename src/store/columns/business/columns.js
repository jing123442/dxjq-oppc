const columns = {
  state: {
    org: [
      ...
      { field: 'address', nameSpan: 10, name: '所在地区', show: { type: 'cascader', formatter: 'address', obj: 'cascaderAddress', sign: '/', ou: 1, noShow: 2, style: 'width: 90%;', placeholder: '请选择所在地区' }, rules: [{ required: true, message: '请选择所在地区', trigger: 'blur' }] },
      ...
      { field: 'orgType', nameSpan: 10, name: '', hide: true, show: { type: 'text', ou: 2, value: 0 } },
