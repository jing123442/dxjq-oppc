...
const columns = {
  order: [
    ...
    { field: 'platformPrice', name: '加气站售卖价 ', hide: true, width: 90, detail: { type: 'span', isDisabled: true, style: 'width: 85%', serial: 1, util: '元/公斤', ou: 6 } },
    ...
    { field: 'marketType', name: '经营模式',  formatter: 'marketType', search: { type: 'select', obj: 'marketType', placeholder: '经营模式' }, detail: { type: 'span', isDisabled: true, style: 'width: 85%', model: 'select', obj: 'marketType', serial: 3, ou: 1 } },
    ...
    { field: 'useropts', stype: 'opt', ispush: true, name: '操作', fixed: 'right', width: 80, list: [{ type: 'detail', name: '详情', }] }
  ],
  ...
  buyOrder: [
    ...
    { field: 'gasPrice', name: '采购量(公斤)', hide: true, width: 90, detail: { type: 'span', isDisabled: true, style: 'width: 85%', serial: 2, util: '公斤', ou: 6 } },
    { field: 'gasPrice', name: '采购金额(元)', hide: true, width: 90, detail: { type: 'span', isDisabled: true, style: 'width: 85%', serial: 2, util: '元', ou: 6 } },
