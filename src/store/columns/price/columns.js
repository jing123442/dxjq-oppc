...
const columns = {
  ...
  rebateFillerAdd: [
    ...
    { field: 'updateDate', name: '发布时间', nameSpan: 8, show: { type: 'date-picker', model: 'datetime', format: 'yyyy-MM-dd HH', valueFormat: 'yyyy-MM-dd HH:00:00', style: 'width: 90%;', placeholder: '请输入发布时间' } }
  ],
  rebateEdit: [
