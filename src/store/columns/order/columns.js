...
const columns = {
  order: [
    ...
    { field: 'carrierOrgName', name: '物流公司', search: { type: 'text', field: 'keyword', placeholder: '请输入物流公司' }, detail: { type: 'span', isDisabled: true, style: 'width: 85%', serial: 1 } },
    ...
    { field: 'gasstationName', name: '加气站', search: { type: 'text', field: 'keyword', placeholder: '请输入加气站' }, detail: { type: 'span', isDisabled: true, style: 'width: 85%', serial: 3 } },
