...
const columns = {
  ...
  snpRetailLog: [
    { field: 'id', hide: true },
    { field: 'gasstationId', hide: true, name: '加气站', stype: 'mapping', mapping: 'gasstationName', fixed: 'left',
      show: { type: 'select', subField: 'gasstationName', obj: 'gasstationList', placeholder: '请选择加气站' },
      rules: [{ required: true, message: '请选择加气站', trigger: 'blur' }] },
