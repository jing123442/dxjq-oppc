<template>
  <div class="template-main">
    <em-table-list ref="tables" :tableListName="'inforlisting'" :authButtonList="authButtonList" :buttonsList="buttonsList" :axios="axios" :queryCustURL="queryCustURL" :responseSuccess="response_success" :queryParam="queryParams" :mode_list="mode_list" :page_status="page_status" :page_column="page_column" :select_list="select_list" @onListEvent="onListEvent" @onReqParams="onReqParams"></em-table-list>
        ...
        <el-form-item>
          ...
          <div style="padding-left: 20px;">
            <el-upload
              ...
              :headers="headers"
              accept=".xls,.xlsx"
              action="information/lng_revice_station_price/imports"
              :auto-upload="false">
...
import { $importListingFile } from '@/service/information'
...
export default {
  ...
  data() {
    return initVueDataOptions(this, {
      ...
      queryCustURL: {
        list: {
          url: 'information/lng_revice_station_price/list',
          method: 'post',
          parse: {
  ...
  computed: {
    ...mapGetters({
      page_column: 'information_listing_column',
      mode_list: 'information_listing_mode_list',
      page_status: 'information_listing_page_status',
      select_list: 'information_listing_select_list',
  ...
  methods: {
    ...
    btnClickEvent(btnObj, row) {
      if (btnObj.type === 'ok') {
        ...
        $importListingFile({ file: _fromData, headers: this.headers }).then(response => {
