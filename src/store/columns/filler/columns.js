...
const columns = {
  ...
  lngPlan: [
    ...
    { field: 'planTime', name: '期望到站日期', nameSpan: 6, width: 140, stype: 'format', formatFun: 'formateTData all', search: { type: 'date-picker', serial: 3, findStyle: 'width: 32%;height: 50px;', style: 'width: 100%', nameSpan: 0, placeholder: { start: '期望到站开始时间', end: '期望到站结束时间' } }, detail: { type: 'span', serial: 4, ou: 1, stype: 'format', formatFun: 'formateTData all' } },
    ...
    { field: 'leaveTime', name: '出港时间', width: 140, stype: 'format', formatFun: 'formateTData all', search: { type: 'date-picker', serial: 4, style: 'width: 100%', findStyle: 'width: 32%;height: 50px;', placeholder: { start: '出港开始时间', end: '出港结束时间' } } },
