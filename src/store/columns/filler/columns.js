...
const columns = {
  ...
  fillerAuth: [
    ...
    { field: 'legalPhone', name: '法人联系电话', nameSpan: 6, show: { type: 'text', ou: 2 }, rules: [{ validator: 'isValidateMobile', message: '请输入正确格式的法人联系电话', trigger: 'blur' }] },
    ...
    { field: 'unionBank', name: '支行行号', nameSpan: 6, show: { type: 'text', ou: 2 }, rules: [{ validator: 'isValidateUnionBank', message: '请输入正确格式的支行行号', trigger: 'blur' }] },
    { field: 'contacts', name: '联系人', nameSpan: 6, show: { type: 'text', ou: 2 } },
    { field: 'mobile', name: '联系电话', nameSpan: 6, show: { type: 'text', ou: 2 }, rules: [{ validator: 'isValidateMobile', message: '请输入正确格式的联系电话', trigger: 'blur' }] },
  ...
  lngPlan: [
    ...
    { field: 'uploadTime', name: '出港时间', hide: true, nameSpan: 6, detail: { type: 'span', serial: 10, ou: 1, stype: 'format', formatFun: 'formateTData all' } },
    { field: 'checkWeight', name: '核准气量(公斤)', hide: true, nameSpan: 6, detail: { type: 'span', serial: 11, ou: 1 } },
    { field: 'operatorReachTime', name: '签收时间', hide: true, nameSpan: 6, detail: { type: 'span', serial: 12, ou: 1 } },
