const columns = {
  order: [
    { field: 'orderId', name: '订单编号', fixed: 'left', detail: { type: 'text', isDisabled: true, style: 'width: 85%', serial: 13 } },
    { field: 'createDate', name: '创建时间', formatFun: 'formateTData all', width: 140, stype: 'format', search: { type: 'date-picker', placeholder: '', findField: 'createDate' }, currSearch: { type: 'select', subField: 'createDateName', hideName: true, obj: 'currDataSearch', value: 'createDate' }, detail: { type: 'text', isDisabled: true, style: 'width: 85%', serial: 15 } },
    { field: 'updateDate', name: '支付时间', formatFun: 'formateTData all', width: 140, stype: 'format', detail: { type: 'text', isDisabled: true, style: 'width: 85%', serial: 16 } },
    { field: 'gasQty', name: '加气量', detail: { type: 'text', isDisabled: true, style: 'width: 85%', serial: 6, util: '公斤' } },
    { field: 'platformPrice', name: '平台挂牌价', hide: true, detail: { type: 'text', isDisabled: true, style: 'width: 85%', serial: 7, util: '元/公斤' } },
    { field: 'actualPrice', name: '平台结算价', hide: true, detail: { type: 'text', isDisabled: true, style: 'width: 85%', serial: 8, util: '元/公斤' } },
    { field: 'amount', name: '订单金额(元)', width: 90 },
    { field: 'amountTotal', name: '订单总金额', width: 90, hide: true, detail: { type: 'text', isDisabled: true, style: 'width: 85%', serial: 9, util: '元', value: function(row) { return Number(row.amount) + Number(row.discountAmount) } } },
    { field: 'discountAmount', name: '优惠金额 ', hide: true, width: 90, detail: { type: 'text', isDisabled: true, style: 'width: 85%', serial: 10, util: '元' } },
    { field: 'amount', name: '实付金额 ', hide: true, width: 90, detail: { type: 'text', isDisabled: true, style: 'width: 85%', serial: 11, util: '元' } },
    { field: 'carrierOrgName', name: '物流公司', detail: { type: 'text', isDisabled: true, style: 'width: 85%', serial: 1 } },
    { field: 'carNumber', name: '车牌号', search: { type: 'text', placeholder: '请输入', findField: 'carNumber' }, currSearch: { type: 'select', subField: 'currFieldName', hideName: true, obj: 'currFieldSearch', value: 'carNumber' }, detail: { type: 'text', isDisabled: true, style: 'width: 85%', serial: 2 } },
    { field: 'driverName', name: '司机姓名', detail: { type: 'text', isDisabled: true, style: 'width: 85%', serial: 4 } },
    { field: 'gasstationName', name: '加气站', detail: { type: 'text', isDisabled: true, style: 'width: 85%', serial: 3 } },
    { field: 'cashierName', name: '收银员姓名', detail: { type: 'text', isDisabled: true, style: 'width: 85%', serial: 5 } },
    { field: 'orderStatus', name: '订单状态', width: 70, formatter: 'orderStatus', detail: { type: 'select', isDisabled: true, obj: 'payType', style: 'width: 85%', serial: 14 } },
    { field: 'payType', name: '支付方式', width: 90, formatter: 'payType', search: { type: 'select', obj: 'payType', placeholder: '支付方式', value: '' }, detail: { type: 'select', isDisabled: true, obj: 'payType', style: 'width: 85%', serial: 12 } },
