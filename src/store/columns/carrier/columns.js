...
const columns = {
  logistics: [
    ...
    { field: 'orgName', stype: 'mapping', name: '公司名称', mapping: 'orgName', fixed: 'left', width: 150, show: { type: 'text', remote: true, obj: 'orgName', style: 'width: 90%;', placeholder: '请输入公司名称' }, search: { type: 'text', placeholder: '请输入公司名称' }, rules: [{ required: true, message: '请输入公司名称', trigger: 'blur' }] },
    { field: 'address', name: '地址', width: 200, show: { type: 'cascader', fieldList: ['address', 'areas'], formatter: 'address', obj: 'cascaderAddress', props: { value: 'label', label: 'label' }, iType: 'string', sign: '', ou: 1, noShow: 2, style: 'width: 90%;', placeholder: '请选择所在地区' }, rules: [{ required: true, message: '请选择所在地区', trigger: 'change' }] },
  ...
  vehicle: [
    ...
    { field: 'truckName', name: '卡车品牌', hide: true, show: { type: 'text', style: 'width: 90%;', placeholder: '请输入卡车品牌' }, detail: { type: 'span', name: '卡车名称', serial: 1, ou: 0, isDisabled: true }, rules: [{ required: true, message: '请输入卡车品牌', trigger: 'blur' }] },
    { field: 'carNumber', name: '车牌号', show: { type: 'text', style: 'width: 90%;', placeholder: '请输入车牌号', isDisabled: true }, search: { type: 'text', placeholder: '请输入车牌号' }, detail: { type: 'span', serial: 2, ou: 0, isDisabled: true }, rules: [{ required: true, message: '请输入车牌号', trigger: 'blur' }] },
    ...
    { field: 'frameNumber', name: '车架号', hide: true, show: { type: 'text', style: 'width: 90%;', placeholder: '请输入车架号' }, detail: { type: 'span', serial: 3, ou: 0, isDisabled: true }, rules: [{ required: true, message: '请输入车架号', trigger: 'blur' }] },
    { field: 'trailerNumber', name: '挂车牌号', hide: true, show: { type: 'text', style: 'width: 90%;', placeholder: '请输入挂车牌号' }, detail: { type: 'span', serial: 4, ou: 0, isDisabled: true } },
    { field: 'purchaseDate', name: '购车日期', hide: true, show: { type: 'date-picker', model: 'date', format: 'yyyy-MM-dd', style: 'width: 90%;', placeholder: '请输入购车日期' }, detail: { type: 'span', serial: 5, ou: 0, isDisabled: true } },
    { field: 'color', name: '颜色', hide: true, show: { type: 'text', style: 'width: 90%;', placeholder: '请输入颜色' }, detail: { type: 'span', serial: 6, ou: 0, isDisabled: true } },
    { field: 'deadWeight', name: '载重量', hide: true, show: { type: 'text', style: 'width: 90%;', placeholder: '请输入载重量' }, detail: { type: 'span', serial: 7, ou: 0, isDisabled: true, util: '吨' } },
    { field: 'capacity', name: '储气罐容量', hide: true, show: { type: 'text', style: 'width: 90%;', placeholder: '请输入储气罐容量' }, detail: { type: 'span', serial: 8, ou: 0, isDisabled: true, util: '升' } },
