export function menuList() {
  return [{
    ...
    children: [
      { path: '/index', name: 'filler', meta: { title: '加气站企业列表', noCache: false } },
    ...
    children: [
      { path: '/index', name: 'carrier', meta: { title: '物流公司', noCache: false } },
    ...
    children: [
      { path: '/index', name: 'policy', meta: { title: '物流公司价格配置', noCache: false } },
      { path: '/index', name: 'policy', meta: { title: '物流公司价格配置', noCache: false } }
    ]
  }, {
    path: '/settlement',
