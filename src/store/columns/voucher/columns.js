...
const columns = {
  list: [
    ...
    { field: 'certificateNumber', name: '凭证号', search: { type: 'select', name: '企业名称', remote: true, field: 'bizUserId', obj: 'orgId', findKey: 'orgName', paramKey: ['param', 'org'], placeholder: '请选择企业名称', required: true } },
