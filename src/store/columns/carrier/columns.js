const columns = {
  ...
  vehicle: [
    ...
    { field: 'truckName', name: '卡车品牌', hide: true, show: { type: 'text', style: 'width: 90%;', placeholder: '请输入卡车品牌' }, rules: [{ required: true, message: '请输入卡车品牌', trigger: 'blur' }] },
    ...
    { field: 'color', name: '颜色', hide: true, show: { type: 'text', style: 'width: 90%;', placeholder: '请输入颜色' } },
    { field: 'deadWeight', name: '载重量', hide: true, show: { type: 'text', style: 'width: 90%;', placeholder: '请输入载重量' } },
    { field: 'capacity', name: '储气罐容量', hide: true, show: { type: 'text', style: 'width: 90%;', placeholder: '请输入储气罐容量' } },
    { field: 'manufacturer', name: '生产厂家', hide: true, show: { type: 'text', style: 'width: 90%;', placeholder: '请输入生产厂家' } },
