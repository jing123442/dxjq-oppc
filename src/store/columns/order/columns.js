...
const columns = {
  ...
  selfOrder: [
    ...
    { field: 'gasstationName', name: '加气站', search: { type: 'text', placeholder: '请输入', findStyle: 'width: 45%', style: 'width: 100%;', findField: 'gasstationName' }, currSearch: { type: 'select', subField: 'currFieldName', style: 'width: 100%;', hideName: true, obj: 'currFieldSearch', value: 'gasstationName' }, show: { type: 'text', placeholder: '请输入' } },
    { field: 'tradeNo', name: '流水号', show: { type: 'text', placeholder: '请输入' } },
