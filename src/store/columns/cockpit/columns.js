...
const columns = {
  ...
  battle: [
    ...
    { field: 'offlineGasQty', name: '日加气量',
      show: { type: 'text', ou: 1, style: 'width: 85%', rule: false, placeholder: '请输入日加气量', util: '吨', rules: [{ validator: 'validateInputValueNumber', message: '日加气量大于零', option: { min: 0, space: 2 }, trigger: 'blur' }, { validator: 'validateMoneyNumber', message: '请输入大于零，或者小数点后保留2位的数', trigger: 'blur' }] },
      ...
      rules: [{ required: true, message: '请输入日加气量', trigger: 'blur' }, { validator: 'validateInputValueNumber', message: '日加气量大于零', option: { min: 0, space: 2 }, trigger: 'blur' }] },
    ...
    { field: 'offlinePrice', name: '结算价',
      show: { type: 'text', ou: 1, style: 'width: 85%', rule: false, placeholder: '请输入结算价', util: '元/公斤', rules: [{ validator: 'validateInputValueNumber', message: '结算价大于零', option: { min: 0, space: 2 }, trigger: 'blur' }, { validator: 'validateMoneyNumber', message: '请输入大于零，或者小数点后保留2位的数', trigger: 'blur' }] },
      ...
      rules: [{ required: true, message: '请选择结算价', trigger: 'blur' }, { validator: 'validateInputValueNumber', message: '结算价大于零', option: { min: 0, space: 2 }, trigger: 'blur' }] },
