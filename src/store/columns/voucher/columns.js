...
const columns = {
  list: [
    ...
    { field: 'certificateNumber', name: '凭证号', search: { type: 'select', remote: true, field: 'bizUserId', obj: 'orgId', findKey: 'orgName', paramKey: ['param', 'org'], placeholder: '请选择企业名称', required: true } },
  ...
  download: [
    ...
    { field: 'changeTime', name: '期间', stype: 'fields', fieldList: ['startDate', 'endDate'], search: { type: 'date-picker', style: 'width: 350px;', dtime: ['00:00:00', '23:59:59'] } },
