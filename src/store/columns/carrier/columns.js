...
const columns = {
  ...
  vehicle: [
    ...
    { field: 'tradeType', name: '交易模式', nameSpan: 5, formatter: 'tradeType',
      search: { type: 'select', obj: 'tradeType', placeholder: '交易模式' },
      detail: { type: 'span', isDisabled: true, style: 'width: 85%', model: 'select', obj: 'tradeType', serial: 6, ou: 0 } },
